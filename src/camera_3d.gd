...
@export var min_distance: float = 20.0  # Minimum camera distance/size
@export var max_distance: float = 40.0  # Maximum camera distance/size
@export var distance_margin: float = 10.0  # Extra margin to add to required distance
@export var smoothing: float = 4.0  # How smoothly the camera moves
